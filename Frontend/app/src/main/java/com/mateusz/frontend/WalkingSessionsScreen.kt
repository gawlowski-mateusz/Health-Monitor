                        ...
                        Row(
                            ...
                            FloatingActionButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = "Add new walking session",
                                    tint = Color.White
                                )
                            }
                        }
...
private suspend fun fetchWalkingSessions(
    ...
    return withContext(Dispatchers.IO) {
        ...
        Log.d(TAG, "Fetching walking sessions from: $url")
        ...
        try {
            ...
            if (jwtToken == null) {
                ...
                withContext(Dispatchers.Main) {
                    Toast.makeText(context, "Please login to view walking sessions", Toast.LENGTH_LONG).show()
                }
                return@withContext null
            }
            ...
            when (responseCode) {
                ...
                HttpURLConnection.HTTP_UNAUTHORIZED -> {
                    ...
                    if (TokenManager.refreshToken(context)) {
                        ...
                        fetchWalkingSessions(context, selectedDate)
                    } else {
                ...
                HttpURLConnection.HTTP_INTERNAL_ERROR -> {
                    ...
                    withContext(Dispatchers.Main) {
                        Toast.makeText(context, "No walking sessions found for $dateStr", Toast.LENGTH_SHORT).show()
                    }
                    null
                }
                else -> {
            ...
            val errorMessage = when (e) {
                ...
                is javax.net.ssl.SSLHandshakeException -> {
                    ...
                    "Error fetching walking sessions: ${e.localizedMessage}"
                }
            }
            withContext(Dispatchers.Main) {
